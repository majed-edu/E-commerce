...
export default function ProductDetails() {
  ...
  const onAdd = () => {
    addItem({ ...data, price: Number(data.price) }, quantity);
        ...
        <div className="product-detail__info">
          ...
          <div className="product-detail__actions">
            ...
            <Button
              ...
              onClick={() => {
                toggle(data);
                notify(wish ? "Removed from wishlist" : "Saved to wishlist");
              }}
            >
              {wish ? "Saved" : "Wishlist"}
            </Button>
                ...
                data.reviews || [
                  {
                    ...
                    comment:
                      "Excellent quality and a very smooth shopping experience.",
                  },
                ]
              ).map((review, index) => (
                <div
